...
//  https://github.com/leafsoar/ls-cocos2d-x/tree/master/MacCpp/Classes/PopupLayer
//
//
...
public:
    ...
    void setTitle(const char* title, int fontsize = 22);
    void setContentText(const char* text, int fontsize = 22, int padding = 50, int paddintTop = 100);
