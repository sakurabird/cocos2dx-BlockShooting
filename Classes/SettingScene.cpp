...
void SettingScene::makeLabels()
{
    ...
    disc1->setPosition(ccp(_visibleSize.width * 0.2, _visibleSize.height * 0.65));
    this->addChild(disc1);
    ...
    button1->setScale(2);
    button1->setPosition(ccp(_visibleSize.width * 0.75,
    ...
    button2->setScale(2);
    button2->setPosition(ccp(_visibleSize.width * 0.75,
    ...
    button3->setScale(2);
    button3->setPosition(ccp(_visibleSize.width * 0.75,
                             disc3->getPositionY() + disc3->getContentSize().height / 3));


//    CCMenuItemLabel* menu3 = CCMenuItemLabel::create(disc3, this, menu_selector(SettingScene::onTapClearUserData));
